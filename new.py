...
class LinkedinBot:
    def __init__(self, username, password):
        ...
        self.driver = webdriver.Chrome('/C:\webdrivers')
...
if __name__ == '__main__':
    ...
    message = "Respected recruiter im Diksha Singhal a 3rd year (I.T) student at iet lucknow. I want to request you for a referal for an internship oppurtinity at airbnb. I have strong data structures and algorithms fundamentals"
